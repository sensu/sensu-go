...
type ListOptions struct {
	TypeMeta `json:",inline" protobuf:"bytes,9,opt,name=typeMeta"`
...
type ExportOptions struct {
	TypeMeta `json:",inline" protobuf:"bytes,3,opt,name=typeMeta"`
...
type DeleteOptions struct {
	TypeMeta `json:",inline" protobuf:"bytes,6,opt,name=typeMeta"`
...
type UpdateOptions struct {
	TypeMeta `json:",inline" protobuf:"bytes,2,opt,name=typeMeta"`
...
type Status struct {
	TypeMeta `json:",inline" protobuf:"bytes,7,opt,name=typeMeta"`
...
type APIGroup struct {
	TypeMeta `json:",inline" protobuf:"bytes,5,opt,name=typeMeta"`
