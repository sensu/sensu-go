...
type Asset struct {
	...
	Filters []string `protobuf:"bytes,3,rep,name=filters" json:"filters"`
	// Metadata contains the name, namespace, labels and annotations of the asset
	ObjectMeta           `protobuf:"bytes,4,opt,name=metadata,embedded=metadata" json:"metadata"`
...
func (*Asset) Descriptor() ([]byte, []int) {
	return fileDescriptor_asset_5e28fe3b8d60591b, []int{0}
}
...
func NewPopulatedAsset(r randyAsset, easy bool) *Asset {
	...
	this.ObjectMeta = *v2
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedAsset(r, 5)
	}
	return this
}
...
func init() { proto.RegisterFile("asset.proto", fileDescriptor_asset_5e28fe3b8d60591b) }

var fileDescriptor_asset_5e28fe3b8d60591b = []byte{
	...
	0x08, 0x32, 0x57, 0x48, 0x92, 0x8b, 0xb9, 0xb4, 0x28, 0x47, 0x82, 0x51, 0x81, 0x51, 0x83, 0xd3,
	0x89, 0xfd, 0xd1, 0x3d, 0x79, 0xe6, 0xd0, 0x20, 0x9f, 0x20, 0x90, 0x98, 0x90, 0x18, 0x17, 0x5b,
	0x71, 0x46, 0xa2, 0xa9, 0xa1, 0x91, 0x04, 0x13, 0x48, 0x36, 0x08, 0xca, 0x13, 0x52, 0xe5, 0x62,
	0x4f, 0xcb, 0xcc, 0x29, 0x49, 0x2d, 0x2a, 0x96, 0x60, 0x56, 0x60, 0xd6, 0xe0, 0x74, 0xe2, 0x7e,
	0x75, 0x4f, 0x1e, 0x26, 0x14, 0x04, 0x63, 0x08, 0x79, 0x72, 0x71, 0x80, 0x6c, 0x4c, 0x49, 0x2c,
	0x49, 0x94, 0x60, 0x51, 0x60, 0xd4, 0xe0, 0x36, 0x12, 0xd7, 0x43, 0x72, 0xbe, 0x9e, 0x7f, 0x52,
	...
	0xc0, 0x5e, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x6c, 0xf4, 0x8f, 0xb9, 0x31, 0x01, 0x00,
	0x00,
}
