...
// Function wraps a Go function for execution in Javascript. It returns an
...
func Function(ctx context.Context, vm *otto.Otto, fn interface{}) func(...interface{}) interface{} {
