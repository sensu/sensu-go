...
type ProxyRequests struct {
	...
	EntityAttributes []byte `protobuf:"bytes,1,opt,name=entity_attributes,json=entityAttributes,proto3" json:"-"`
...
func (m *ProxyRequests) GetEntityAttributes() []byte {
	if m != nil {
...
func (this *ProxyRequests) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.EntityAttributes, that1.EntityAttributes) {
		return false
	}
...
func (m *ProxyRequests) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EntityAttributes) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCheck(dAtA, i, uint64(len(m.EntityAttributes)))
		i += copy(dAtA[i:], m.EntityAttributes)
	}
	if m.Splay {
		dAtA[i] = 0x10
		i++
...
func NewPopulatedProxyRequests(r randyCheck, easy bool) *ProxyRequests {
	this := &ProxyRequests{}
	v5 := r.Intn(100)
	this.EntityAttributes = make([]byte, v5)
	for i := 0; i < v5; i++ {
		this.EntityAttributes[i] = byte(r.Intn(256))
	}
...
func (m *ProxyRequests) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.EntityAttributes = append(m.EntityAttributes[:0], dAtA[iNdEx:postIndex]...)
			if m.EntityAttributes == nil {
				m.EntityAttributes = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
...
var fileDescriptorCheck = []byte{
	...
	0xcf, 0x51, 0x9f, 0x09, 0xcd, 0xf5, 0x2a, 0x08, 0xb5, 0xce, 0xf9, 0xdc, 0x68, 0xa6, 0x60, 0xf6,
	...
	,
}
