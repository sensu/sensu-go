...
type CheckConfig struct {
	...
	CheckHooks []CheckHook `protobuf:"bytes,13,rep,name=check_hooks,json=checkHooks" json:"check_hooks"`
}
...
type CheckHook struct {
	...
	Hooks []Hook `protobuf:"bytes,1,rep,name=hooks" json:"hooks"`
...
func (m *CheckHook) GetHooks() []Hook {
	if m != nil {
		return m.Hooks
	}
	return nil
...
func NewPopulatedCheckHook(r randyCheck, easy bool) *CheckHook {
	...
	if r.Intn(10) != 0 {
		v9 := r.Intn(5)
		this.Hooks = make([]Hook, v9)
		for i := 0; i < v9; i++ {
			v10 := NewPopulatedHook(r, easy)
			this.Hooks[i] = *v10
		}
	}
...
var fileDescriptorCheck = []byte{
	...
	,
}
