...
type ProxyRequests struct {
	// ClientAttributes store serialized arbitrary JSON-encoded data to match
	// clients in the registry.
	ClientAttributes []byte `protobuf:"bytes,1,opt,name=client_attributes,json=clientAttributes,proto3" json:"-"`
...
func (m *ProxyRequests) GetClientAttributes() []byte {
	if m != nil {
...
func (this *ProxyRequests) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.ClientAttributes, that1.ClientAttributes) {
		return false
	}
...
func (m *ProxyRequests) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ClientAttributes) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCheck(dAtA, i, uint64(len(m.ClientAttributes)))
		i += copy(dAtA[i:], m.ClientAttributes)
	}
	if m.Splay {
		dAtA[i] = 0x10
		i++
...
func NewPopulatedProxyRequests(r randyCheck, easy bool) *ProxyRequests {
	this := &ProxyRequests{}
	v5 := r.Intn(100)
	this.ClientAttributes = make([]byte, v5)
	for i := 0; i < v5; i++ {
		this.ClientAttributes[i] = byte(r.Intn(256))
	}
...
func (m *ProxyRequests) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClientAttributes", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ClientAttributes = append(m.ClientAttributes[:0], dAtA[iNdEx:postIndex]...)
			if m.ClientAttributes == nil {
				m.ClientAttributes = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
...
var fileDescriptorCheck = []byte{
	...
	,
}
