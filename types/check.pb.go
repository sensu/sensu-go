...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	v6 := r.Intn(100)
	this.ExtendedAttributes = make([]byte, v6)
	for i := 0; i < v6; i++ {
	...
	if r.Intn(10) != 0 {
		v7 := r.Intn(5)
		this.CheckHooks = make([]CheckHook, v7)
		for i := 0; i < v7; i++ {
			v8 := NewPopulatedCheckHook(r, easy)
			this.CheckHooks[i] = *v8
		}
	}
...
func NewPopulatedCheck(r randyCheck, easy bool) *Check {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.History = make([]CheckHistory, v10)
		for i := 0; i < v10; i++ {
			v11 := NewPopulatedCheckHistory(r, easy)
			this.History[i] = *v11
		}
	}
...
func randFieldCheck(dAtA []byte, r randyCheck, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateCheck(dAtA, uint64(v13))
	case 1:
		dAtA = encodeVarintPopulateCheck(dAtA, uint64(key))
...
var fileDescriptorCheck = []byte{
	...
	,
}
