...
// FlapThreshold is a wrapper type for nullability.
type FlapThreshold struct {
	Value uint32 `protobuf:"varint,1,opt,name=Value,proto3" json:"Value,omitempty"`
}

func (m *FlapThreshold) Reset()                    { *m = FlapThreshold{} }
func (m *FlapThreshold) String() string            { return proto.CompactTextString(m) }
func (*FlapThreshold) ProtoMessage()               {}
func (*FlapThreshold) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{0} }

func (m *FlapThreshold) GetValue() uint32 {
	if m != nil {
		return m.Value
	}
	return 0
...
func (*CheckRequest) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{1} }
...
func (*ProxyRequests) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{2} }
...
type CheckConfig struct {
	...
	HighFlapThreshold *FlapThreshold `protobuf:"bytes,4,opt,name=high_flap_threshold,json=highFlapThreshold" json:"high_flap_threshold,omitempty"`
	...
	// the check. Sensu uses the same flap detection algorithm as Nagios.
	LowFlapThreshold *FlapThreshold `protobuf:"bytes,6,opt,name=low_flap_threshold,json=lowFlapThreshold" json:"low_flap_threshold,omitempty"`
...
func (*CheckConfig) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{3} }
...
func (m *CheckConfig) GetHighFlapThreshold() *FlapThreshold {
	if m != nil {
...
func (m *CheckConfig) GetLowFlapThreshold() *FlapThreshold {
	if m != nil {
...
func (*Check) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{4} }
...
func (m *Check) GetHighFlapThreshold() *FlapThreshold {
	if m != nil {
		return m.HighFlapThreshold
	}
	return nil
...
func (m *Check) GetLowFlapThreshold() *FlapThreshold {
	if m != nil {
		return m.LowFlapThreshold
	}
	return nil
...
func (*CheckHistory) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{5} }
...
func init() {
	proto.RegisterType((*FlapThreshold)(nil), "sensu.types.FlapThreshold")
...
func (this *FlapThreshold) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*FlapThreshold)
	if !ok {
		that2, ok := that.(FlapThreshold)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CheckConfig) Equal(that interface{}) bool {
	...
	if !this.HighFlapThreshold.Equal(that1.HighFlapThreshold) {
		return false
	}
	if this.Interval != that1.Interval {
		return false
	}
	if !this.LowFlapThreshold.Equal(that1.LowFlapThreshold) {
		return false
	}
...
func (m *FlapThreshold) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *FlapThreshold) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Value != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.Value))
	}
	return i, nil
}
...
func (m *CheckConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HighFlapThreshold != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.HighFlapThreshold.Size()))
		n2, err := m.HighFlapThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
	...
	if m.LowFlapThreshold != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.LowFlapThreshold.Size()))
		n3, err := m.LowFlapThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *Check) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HighFlapThreshold != nil {
		...
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.HighFlapThreshold.Size()))
		n6, err := m.HighFlapThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
	...
	if m.LowFlapThreshold != nil {
		...
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.LowFlapThreshold.Size()))
		n7, err := m.LowFlapThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
	...
	if m.Subdue != nil {
		...
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.Subdue.Size()))
		n8, err := m.Subdue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.ProxyRequests != nil {
		...
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.ProxyRequests.Size()))
		n9, err := m.ProxyRequests.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func NewPopulatedFlapThreshold(r randyCheck, easy bool) *FlapThreshold {
	this := &FlapThreshold{}
...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	if r.Intn(10) != 0 {
		this.HighFlapThreshold = NewPopulatedFlapThreshold(r, easy)
	}
	this.Interval = uint32(r.Uint32())
	if r.Intn(10) != 0 {
		this.LowFlapThreshold = NewPopulatedFlapThreshold(r, easy)
	}
...
func NewPopulatedCheck(r randyCheck, easy bool) *Check {
	...
	v19 := r.Intn(10)
	this.Silenced = make([]string, v19)
	for i := 0; i < v19; i++ {
		this.Silenced[i] = string(randStringCheck(r))
	}
	if r.Intn(10) != 0 {
		v20 := r.Intn(5)
		this.Hooks = make([]*Hook, v20)
		for i := 0; i < v20; i++ {
			this.Hooks[i] = NewPopulatedHook(r, easy)
		}
	}
	v21 := r.Intn(100)
	this.ExtendedAttributes = make([]byte, v21)
	for i := 0; i < v21; i++ {
		this.ExtendedAttributes[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
...
func randFieldCheck(dAtA []byte, r randyCheck, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateCheck(dAtA, uint64(v23))
	case 1:
		dAtA = encodeVarintPopulateCheck(dAtA, uint64(key))
...
func (m *FlapThreshold) Size() (n int) {
	var l int
	_ = l
	if m.Value != 0 {
		n += 1 + sovCheck(uint64(m.Value))
	}
	return n
}
...
func (m *FlapThreshold) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FlapThreshold: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlapThreshold: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *CheckConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.HighFlapThreshold == nil {
				m.HighFlapThreshold = &FlapThreshold{}
			}
			if err := m.HighFlapThreshold.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 6:
			...
			if m.LowFlapThreshold == nil {
				m.LowFlapThreshold = &FlapThreshold{}
			}
			if err := m.LowFlapThreshold.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
var fileDescriptorCheck = []byte{
	...
	,
}
