...
type CheckConfig struct {
	...
	CheckHooks []CheckHook `protobuf:"bytes,14,rep,name=check_hooks,json=checkHooks" json:"check_hooks"`
...
func (m *CheckConfig) GetCheckHooks() []CheckHook {
	if m != nil {
		return m.CheckHooks
	}
	return nil
...
func (m *CheckHook) Reset()                    { *m = CheckHook{} }
func (m *CheckHook) String() string            { return proto.CompactTextString(m) }
func (*CheckHook) ProtoMessage()               {}
func (*CheckHook) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{2} }

func (m *CheckHook) GetHooks() []string {
	if m != nil {
		return m.Hooks
	}
	return nil
...
func (m *CheckHook) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*CheckHook)(nil), "sensu.types.CheckHook")
...
func (this *CheckHook) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CheckHook)
	if !ok {
		that2, ok := that.(CheckHook)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *CheckHook) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CheckHook) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	if r.Intn(10) != 0 {
		v9 := r.Intn(5)
		this.CheckHooks = make([]CheckHook, v9)
		for i := 0; i < v9; i++ {
			v10 := NewPopulatedCheckHook(r, easy)
...
func NewPopulatedCheckHook(r randyCheck, easy bool) *CheckHook {
	this := &CheckHook{}
	v11 := r.Intn(10)
	this.Hooks = make([]string, v11)
	for i := 0; i < v11; i++ {
		this.Hooks[i] = string(randStringCheck(r))
	}
...
func (m *CheckConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.CheckHooks = append(m.CheckHooks, CheckHook{})
...
func (m *CheckHook) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckHook: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckHook: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorCheck = []byte{
	...
	,
}
