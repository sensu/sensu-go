...
type Entity struct {
	...
	System         System         `protobuf:"bytes,2,opt,name=system" json:"system"`
	Subscriptions  []string       `protobuf:"bytes,3,rep,name=subscriptions" json:"subscriptions"`
	...
	Deregistration Deregistration `protobuf:"bytes,6,opt,name=deregistration" json:"deregistration"`
	User           string         `protobuf:"bytes,7,opt,name=user,proto3" json:"user,omitempty"`
	// ExtendedAttributes store serialized arbitrary JSON-encoded data
	ExtendedAttributes []byte `protobuf:"bytes,8,opt,name=extended_attributes,json=extendedAttributes,proto3" json:"-"`
	// Redact contains the fields to redact on the agent
	Redact []string `protobuf:"bytes,9,rep,name=redact" json:"redact,omitempty"`
	// Metadata contains the name, namespace, labels and annotations of the entity
	ObjectMeta           `protobuf:"bytes,10,opt,name=metadata,embedded=metadata" json:"metadata"`
...
func (*Entity) Descriptor() ([]byte, []int) {
	return fileDescriptor_entity_49a5119b1f091094, []int{0}
}
...
func (*System) Descriptor() ([]byte, []int) {
	return fileDescriptor_entity_49a5119b1f091094, []int{1}
}
...
func (*Network) Descriptor() ([]byte, []int) {
	return fileDescriptor_entity_49a5119b1f091094, []int{2}
}
...
func (*NetworkInterface) Descriptor() ([]byte, []int) {
	return fileDescriptor_entity_49a5119b1f091094, []int{3}
}
...
func (*Deregistration) Descriptor() ([]byte, []int) {
	return fileDescriptor_entity_49a5119b1f091094, []int{4}
}
...
func NewPopulatedEntity(r randyEntity, easy bool) *Entity {
	...
	this.ObjectMeta = *v6
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedEntity(r, 11)
	}
	return this
}
...
func init() { proto.RegisterFile("entity.proto", fileDescriptor_entity_49a5119b1f091094) }

var fileDescriptor_entity_49a5119b1f091094 = []byte{
	// 636 bytes of a gzipped FileDescriptorProto
	,
}
