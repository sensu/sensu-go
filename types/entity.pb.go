...
func NewPopulatedNetwork(r randyEntity, easy bool) *Network {
	...
	if r.Intn(10) != 0 {
		v5 := r.Intn(5)
		this.Interfaces = make([]NetworkInterface, v5)
		for i := 0; i < v5; i++ {
			v6 := NewPopulatedNetworkInterface(r, easy)
			this.Interfaces[i] = *v6
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
var fileDescriptorEntity = []byte{
	...
	,
}
