...
type Entity struct {
	...
	ExtendedAttributes []byte `protobuf:"bytes,12,opt,name=extended_attributes,json=extendedAttributes,proto3" json:"extended_attributes,omitempty"`
}
...
func NewPopulatedNetwork(r randyEntity, easy bool) *Network {
	...
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.Interfaces = make([]NetworkInterface, v6)
		for i := 0; i < v6; i++ {
			v7 := NewPopulatedNetworkInterface(r, easy)
			this.Interfaces[i] = *v7
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
var fileDescriptorEntity = []byte{
	...
	,
}
