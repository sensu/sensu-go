...
type HookConfig struct {
	...
	// Namespace to which the hook belongs to
...
func (*HookConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_hook_207370eadb64e29e, []int{0}
}
...
func (m *HookConfig) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (*Hook) Descriptor() ([]byte, []int) {
	return fileDescriptor_hook_207370eadb64e29e, []int{1}
}
...
func (*HookList) Descriptor() ([]byte, []int) {
	return fileDescriptor_hook_207370eadb64e29e, []int{2}
}
...
func (m *HookConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Namespace) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintHook(dAtA, i, uint64(len(m.Namespace)))
...
func NewPopulatedHookConfig(r randyHook, easy bool) *HookConfig {
	...
	this.Namespace = string(randStringHook(r))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedHook(r, 8)
	}
	return this
}
...
func init() { proto.RegisterFile("hook.proto", fileDescriptor_hook_207370eadb64e29e) }

var fileDescriptor_hook_207370eadb64e29e = []byte{
	// 393 bytes of a gzipped FileDescriptorProto
	,
}
