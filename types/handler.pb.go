...
type Handler struct {
	...
	Fitlers []*EventFilter `protobuf:"bytes,8,rep,name=fitlers" json:"filters"`
...
func (m *Handler) GetFitlers() []*EventFilter {
	if m != nil {
		return m.Fitlers
	}
	return nil
...
func (this *Handler) Equal(that interface{}) bool {
	...
	if len(this.Fitlers) != len(that1.Fitlers) {
		return false
	}
	for i := range this.Fitlers {
		if !this.Fitlers[i].Equal(that1.Fitlers[i]) {
			return false
		}
	}
...
func NewPopulatedHandler(r randyHandler, easy bool) *Handler {
	...
	if r.Intn(10) != 0 {
		v2 := r.Intn(5)
		this.Fitlers = make([]*EventFilter, v2)
		for i := 0; i < v2; i++ {
			this.Fitlers[i] = NewPopulatedEventFilter(r, easy)
		}
	}
	v3 := r.Intn(10)
...
func (m *Handler) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Fitlers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Fitlers = append(m.Fitlers, &EventFilter{})
			if err := m.Fitlers[len(m.Fitlers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
...
var fileDescriptorHandler = []byte{
	...
	,
}
