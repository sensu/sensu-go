...
func (*Handler) Descriptor() ([]byte, []int) {
	return fileDescriptor_handler_d3dbee17395e0f62, []int{0}
}
...
func (*HandlerSocket) Descriptor() ([]byte, []int) {
	return fileDescriptor_handler_d3dbee17395e0f62, []int{1}
}
...
func NewPopulatedHandler(r randyHandler, easy bool) *Handler {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedHandler(r, 11)
	}
	return this
}
...
func init() { proto.RegisterFile("handler.proto", fileDescriptor_handler_d3dbee17395e0f62) }

var fileDescriptor_handler_d3dbee17395e0f62 = []byte{
	...
	0xa5, 0x31, 0x0a, 0x0c, 0xa7, 0x68, 0x67, 0x7d, 0x1b, 0xfd, 0x57, 0x11, 0xc1, 0xc8, 0x2f, 0x90,
	0x9e, 0x5d, 0xd0, 0xe0, 0x56, 0x26, 0xbb, 0xee, 0x8d, 0x36, 0x80, 0xb7, 0xe6, 0x0b, 0xc4, 0xec,
	0x21, 0x75, 0x76, 0xba, 0x06, 0xbc, 0x82, 0x20, 0xf3, 0xfa, 0x36, 0x42, 0x2e, 0xf0, 0x9b, 0x3d,
	0xfa, 0xfd, 0x33, 0x24, 0x5f, 0xbb, 0x90, 0x7c, 0xef, 0x42, 0x72, 0xe8, 0x42, 0x72, 0xd3, 0x85,
	0xe4, 0x47, 0x17, 0x92, 0x2f, 0xbf, 0xc2, 0x93, 0x0f, 0xa7, 0xb8, 0xb8, 0x7c, 0x8e, 0x6f, 0xe4,
	0xf9, 0x9f, 0x00, 0x00, 0x00, 0xff, 0xff, 0x07, 0xaa, 0x5e, 0xf9, 0x7c, 0x02, 0x00, 0x00,
}
