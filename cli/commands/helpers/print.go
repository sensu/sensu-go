...
func PrintList(cmd *cobra.Command, format string, printTable printTableFunc, objects []corev2.Resource, v interface{}, header http.Header) error {
...
// Print displays
func Print(cmd *cobra.Command, format string, printTable printTableFunc, objects []corev2.Resource, v interface{}) error {
