...
func (o *silencedOpts) Apply(s *corev2.Silenced) (err error) {
...
func askName(help string, askOpts ...survey.AskOpt) (string, error) {
	...
	return corev2.SilencedName(name.Subscription, name.Check)
}

func toOpts(s *corev2.Silenced) *silencedOpts {
	var o silencedOpts
