...
func TestListCommand(t *testing.T) {
	...
	assert.Regexp("fallback-pipeline", cmd.Short)
}
...
func TestListCommandRunEClosure(t *testing.T) {
	...
	resources := []corev2.FallbackPipeline{}
	client.On("List", mock.Anything, &resources, mock.Anything, mock.Anything).Return(nil).Run(
		func(args mock.Arguments) {
			resources := args[1].(*[]corev2.FallbackPipeline)
			*resources = []corev2.FallbackPipeline{
				*corev2.FixtureFallbackPipeline("1", "something"),
				*corev2.FixtureFallbackPipeline("2", "important"),
			}
		},
	)
...
func TestListCommandRunEClosureWithTable(t *testing.T) {
	...
	client.On("List", mock.Anything, &resources, mock.Anything, mock.Anything).Return(nil).Run(
		func(args mock.Arguments) {
			resources := args[1].(*[]corev2.FallbackPipeline)
			*resources = []corev2.FallbackPipeline{
				*corev2.FixtureFallbackPipeline("foo", "default"),
				*corev2.FixtureFallbackPipeline("bar", "default"),
			}
		},
	)
	...
	assert.Contains(out, "FallbackPipelineList") // Heading
