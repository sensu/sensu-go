...
//go:generate -command protoc protoc --plugin $GOPATH/bin/protoc-gen-gofast --gofast_out=plugins:../../../../../../ -I=$GOPATH/pkg/mod -I=$GOPATH/pkg/mod/github.com/gogo/protobuf@v1.3.1/protobuf -I=../../../../../../
//go:generate protoc github.com/sensu/sensu-go/api/core/v3/entitystate.proto github.com/sensu/sensu-go/api/core/v3/entityconfig.proto
