...
func TestOpampAgentConfigSetMetadata(t *testing.T) {
...
func TestOpampAgentConfigStoreName(t *testing.T) {
	var value OpampAgentConfig
	got := value.StoreName()
	if len(got) == 0 {
		t.Error("undefined store suffix")
	}
...
func TestOpampAgentConfigRBACName(t *testing.T) {
	var value OpampAgentConfig
	got := value.RBACName()
	if len(got) == 0 {
		t.Error("undefined rbac name")
...
func TestOpampAgentConfigURIPath(t *testing.T) {
	var value OpampAgentConfig
	value.Metadata = &corev2.ObjectMeta{
		Namespace: "default",
		Name:      "foo",
...
func TestOpampAgentConfigValidate(t *testing.T) {
	var value OpampAgentConfig
	if err := value.Validate(); err == nil {
		t.Errorf("expected non-nil error for nil metadata")
	}
...
func TestOpampAgentConfigUnmarshalJSON(t *testing.T) {
	msg := []byte(`{"metadata": {"namespace": "default", "name": "foo"}}`)
	var value OpampAgentConfig
	if err := json.Unmarshal(msg, &value); err != nil {
		t.Fatal(err)
...
func TestOpampAgentConfigGetTypeMeta(t *testing.T) {
	var value OpampAgentConfig
	meta := value.GetTypeMeta()
	if got, want := meta.APIVersion, "core/v3"; got != want {
		t.Errorf("bad api version: got %s, want %s", got, want)
	}
	if got, want := meta.Type, "OpampAgentConfig"; got != want {
		t.Errorf("bad type: got %s, want %s", got, want)
	}
}
