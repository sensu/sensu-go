...
#ProxyRequests: {
	...
	entityAttributes?: [...string] @protobuf(1,string,name=entity_attributes,#"(gogoproto.jsontag)="entity_attributes""#)
	...
	// calculation.
	splayCoverage?: uint32 @protobuf(3,uint32,name=splay_coverage,#"(gogoproto.jsontag)="splay_coverage""#)
}
...
#CheckConfig: {
	...
	highFlapThreshold?: uint32 @protobuf(4,uint32,name=high_flap_threshold,#"(gogoproto.jsontag)="high_flap_threshold""#)
	...
	lowFlapThreshold?: uint32 @protobuf(6,uint32,name=low_flap_threshold,#"(gogoproto.jsontag)="low_flap_threshold""#)
	...
	runtimeAssets?: [...string] @protobuf(10,string,name=runtime_assets,#"(gogoproto.jsontag)="runtime_assets""#)
	...
	// resource
	proxyEntityName?: string @protobuf(13,string,name=proxy_entity_name,#"(gogoproto.jsontag)="proxy_entity_name""#,#"(gogoproto.customname)="ProxyEntityName""#)

	// CheckHooks is the list of check hooks for the check
	checkHooks?: [...#HookList] @protobuf(14,HookList,name=check_hooks,#"(gogoproto.jsontag)="check_hooks""#,"(gogoproto.nullable)=false")
	...
	roundRobin?: bool @protobuf(21,bool,name=round_robin,#"(gogoproto.jsontag)="round_robin""#)
	...
	outputMetricFormat?: string @protobuf(22,string,name=output_metric_format,#"(gogoproto.jsontag)="output_metric_format""#)
	...
	outputMetricHandlers?: [...string] @protobuf(23,string,name=output_metric_handlers,#"(gogoproto.jsontag)="output_metric_handlers""#)

	// EnvVars is the list of environment variables to set for the check's
	// execution environment.
	envVars?: [...string] @protobuf(24,string,name=env_vars,#"(gogoproto.jsontag)="env_vars""#)
	...
	outputMetricTags?: [...#MetricTag] @protobuf(30,MetricTag,name=output_metric_tags,#"(gogoproto.jsontag)="output_metric_tags,omitempty""#,#"(gogoproto.moretags)="yaml: \"output_metric_tags,omitempty\"""#)
	...
	outputMetricThresholds?: [...#MetricThreshold] @protobuf(33,MetricThreshold,name=output_metric_thresholds,#"(gogoproto.jsontag)="output_metric_thresholds,omitempty""#,#"(gogoproto.moretags)="yaml: \"output_metric_thresholds,omitempty\"""#)
}
...
#Check: {
	...
	// check's history
	totalStateChange?: uint32 @protobuf(29,uint32,name=total_state_change,#"(gogoproto.jsontag)="total_state_change""#)

	// LastOK displays last time this check was ok; if event status is 0 this is
	// set to timestamp
	lastOk?: int64 @protobuf(30,int64,name=last_ok,#"(gogoproto.customname)="LastOK""#,#"(gogoproto.jsontag)="last_ok""#)
	...
	occurrencesWatermark?: int64 @protobuf(32,int64,name=occurrences_watermark,#"(gogoproto.jsontag)="occurrences_watermark""#)
	...
	// will be expected to follow in order to be extracted.
	outputMetricFormat?: string @protobuf(35,string,name=output_metric_format,#"(gogoproto.jsontag)="output_metric_format""#)

	// OutputMetricHandlers is the list of event handlers that will
	// respond to metrics that have been extracted from the check.
	outputMetricHandlers?: [...string] @protobuf(36,string,name=output_metric_handlers,#"(gogoproto.jsontag)="output_metric_handlers""#)

	// EnvVars is the list of environment variables to set for the check's
	// execution environment.
	envVars?: [...string] @protobuf(37,string,name=env_vars,#"(gogoproto.jsontag)="env_vars""#)
	...
	isSilenced?: bool @protobuf(42,bool,name=is_silenced,#"(gogoproto.jsontag)="is_silenced""#)

	// OutputMetricTags is list of metric tags to apply to metrics extracted from check output.
	outputMetricTags?: [...#MetricTag] @protobuf(43,MetricTag,name=output_metric_tags,#"(gogoproto.jsontag)="output_metric_tags,omitempty""#,#"(gogoproto.moretags)="yaml: \"output_metric_tags,omitempty\"""#)
	...
	ProcessedBy?: string @protobuf(45,string,#"(gogoproto.jsontag)="processed_by,omitempty""#,#"(gogoproto.moretags)="yaml: \"processed_by\"""#)
	...
	// the check status.
	outputMetricThresholds?: [...#MetricThreshold] @protobuf(47,MetricThreshold,name=output_metric_thresholds,#"(gogoproto.jsontag)="output_metric_thresholds,omitempty""#,#"(gogoproto.moretags)="yaml: \"output_metric_thresholds,omitempty\"""#)
