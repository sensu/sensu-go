...
type System struct {
	...
	ARMVersion           uint8    `protobuf:"varint,8,opt,name=arm_version,json=armVersion,proto3,casttype=uint8" json:"arm_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *System) GetARMVersion() uint8 {
	if m != nil {
		return m.ARMVersion
	}
	return 0
...
var fileDescriptor_cf50d946d740d100 = []byte{
	...
	,
}
...
func NewPopulatedSystem(r randyEntity, easy bool) *System {
	...
	this.ARMVersion = uint8(r.Uint32())
	if !easy && r.Intn(10) != 0 {
	...
	for iNdEx < l {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ARMVersion |= uint8(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
