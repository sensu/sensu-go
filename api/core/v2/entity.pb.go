...
type Process struct {
	...
	Ppid                 int32    `protobuf:"varint,3,opt,name=ppid,proto3" json:"ppid"`
	Status               string   `protobuf:"bytes,4,opt,name=status,proto3" json:"status"`
	Background           bool     `protobuf:"varint,5,opt,name=background,proto3" json:"background"`
	Running              bool     `protobuf:"varint,6,opt,name=running,proto3" json:"running"`
	Created              int64    `protobuf:"varint,7,opt,name=created,proto3" json:"created"`
	MemoryPercent        float32  `protobuf:"fixed32,8,opt,name=memory_percent,json=memoryPercent,proto3" json:"memory_percent"`
	CpuPercent           float64  `protobuf:"fixed64,9,opt,name=cpu_percent,json=cpuPercent,proto3" json:"cpu_percent"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Process) GetBackground() bool {
	if m != nil {
		return m.Background
	}
	return false
...
func (m *Process) GetRunning() bool {
	if m != nil {
		return m.Running
	}
	return false
...
func (m *Process) GetCreated() int64 {
	if m != nil {
		return m.Created
	}
	return 0
...
func (m *Process) GetCpuPercent() float64 {
	if m != nil {
		return m.CpuPercent
	}
	return 0
...
var fileDescriptor_cf50d946d740d100 = []byte{
	...
	,
}
...
func (this *Process) Equal(that interface{}) bool {
	...
	if this.MemoryPercent != that1.MemoryPercent {
		return false
	}
...
func (m *Process) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MemoryPercent != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.MemoryPercent))))
		i--
		dAtA[i] = 0x45
	}
	if m.Created != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.Created))
		i--
		dAtA[i] = 0x38
	}
	if m.Running {
	...
	if len(m.Status) > 0 {
		...
		i = encodeVarintEntity(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0x22
	}
	if m.Ppid != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.Ppid))
		i--
		dAtA[i] = 0x18
	}
	if m.Pid != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.Pid))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Name) > 0 {
...
func NewPopulatedProcess(r randyEntity, easy bool) *Process {
	...
	this.Ppid = int32(r.Int31())
	if r.Intn(2) == 0 {
		this.Ppid *= -1
	}
	this.Status = string(randStringEntity(r))
	this.Background = bool(bool(r.Intn(2) == 0))
	this.Running = bool(bool(r.Intn(2) == 0))
	this.Created = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.Created *= -1
	}
	this.MemoryPercent = float32(r.Float32())
	if r.Intn(2) == 0 {
		this.MemoryPercent *= -1
	}
	this.CpuPercent = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.CpuPercent *= -1
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedEntity(r, 10)
	}
	return this
}
...
func (m *Process) Size() (n int) {
	...
	if m.Pid != 0 {
		n += 1 + sovEntity(uint64(m.Pid))
	}
	if m.Ppid != 0 {
		n += 1 + sovEntity(uint64(m.Ppid))
	}
	l = len(m.Status)
	if l > 0 {
		n += 1 + l + sovEntity(uint64(l))
	...
	if m.Created != 0 {
		n += 1 + sovEntity(uint64(m.Created))
	}
	if m.MemoryPercent != 0 {
		n += 5
	}
...
func (m *Process) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			iNdEx += 4
			m.MemoryPercent = float32(math.Float32frombits(v))
		case 9:
			if wireType != 1 {
