...
#Mutator: {
	...
	envVars?: [...string] @protobuf(4,string,name=env_vars,#"(gogoproto.jsontag)="env_vars""#)

	// RuntimeAssets are a list of assets required to execute a mutator.
	runtimeAssets?: [...string] @protobuf(8,string,name=runtime_assets,#"(gogoproto.jsontag)="runtime_assets""#)
