...
type CheckConfig struct {
	...
	Pipelines            []*Pipeline `protobuf:"bytes,32,rep,name=pipelines,proto3" json:"pipelines"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type Check struct {
	...
	// Pipelines are the pipelines this check will use to process its events.
	Pipelines            []*Pipeline `protobuf:"bytes,46,rep,name=pipelines,proto3" json:"pipelines"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
var fileDescriptor_6b843265b29f5373 = []byte{
	...
	,
}
...
func (this *CheckConfig) GetPipelines() []*Pipeline {
...
func (this *Check) GetPipelines() []*Pipeline {
	return this.Pipelines
}
...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	if r.Intn(5) != 0 {
		v21 := r.Intn(5)
		this.Pipelines = make([]*Pipeline, v21)
		for i := 0; i < v21; i++ {
...
func NewPopulatedCheck(r randyCheck, easy bool) *Check {
	...
	if r.Intn(5) != 0 {
		v36 := r.Intn(5)
		this.Pipelines = make([]*Pipeline, v36)
		for i := 0; i < v36; i++ {
			this.Pipelines[i] = NewPopulatedPipeline(r, easy)
		}
	}
