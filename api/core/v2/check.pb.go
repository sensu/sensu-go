...
type CheckConfig struct {
	...
	// OutputMetricTags is a key value map of tags to apply to metrics extracted from check output.
	OutputMetricTags     map[string]string `protobuf:"bytes,30,rep,name=output_metric_tags,json=outputMetricTags,proto3" json:"output_metric_tags,omitempty" yaml: "annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type Check struct {
	...
	// OutputMetricTags is a key value map of tags to apply to metrics extracted from check output.
	OutputMetricTags map[string]string `protobuf:"bytes,43,rep,name=output_metric_tags,json=outputMetricTags,proto3" json:"output_metric_tags,omitempty" yaml: "annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// ExtendedAttributes store serialized arbitrary JSON-encoded data
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "sensu.core.v2.CheckConfig.OutputMetricTagsEntry")
	proto.RegisterType((*Check)(nil), "sensu.core.v2.Check")
	proto.RegisterMapType((map[string]string)(nil), "sensu.core.v2.Check.OutputMetricTagsEntry")
...
var fileDescriptor_6b843265b29f5373 = []byte{
	...
	,
}
...
func (this *CheckConfig) Equal(that interface{}) bool {
	...
	for i := range this.OutputMetricTags {
		if this.OutputMetricTags[i] != that1.OutputMetricTags[i] {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
...
type CheckConfigFace interface {
	...
	GetSecrets() []*Secret
	GetOutputMetricTags() map[string]string
}
...
func (this *CheckConfig) GetOutputMetricTags() map[string]string {
...
func (this *Check) GetOutputMetricTags() map[string]string {
	return this.OutputMetricTags
}
...
func (m *CheckConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OutputMetricTags) > 0 {
		for k := range m.OutputMetricTags {
			v := m.OutputMetricTags[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintCheck(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	if r.Intn(5) != 0 {
		v20 := r.Intn(10)
		this.OutputMetricTags = make(map[string]string)
		for i := 0; i < v20; i++ {
			this.OutputMetricTags[randStringCheck(r)] = randStringCheck(r)
		}
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedCheck(r, 31)
	}
	return this
}
...
func (m *CheckConfig) Size() (n int) {
	...
	if len(m.OutputMetricTags) > 0 {
		for k, v := range m.OutputMetricTags {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovCheck(uint64(len(k))) + 1 + len(v) + sovCheck(uint64(len(v)))
			n += mapEntrySize + 2 + sovCheck(uint64(mapEntrySize))
		}
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *CheckConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			...
			if m.OutputMetricTags == nil {
				m.OutputMetricTags = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.OutputMetricTags[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCheck(dAtA[iNdEx:])
