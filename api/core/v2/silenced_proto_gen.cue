...
#Silenced: {
	...
	// set to true
	expireOnResolve?: bool @protobuf(3,bool,name=expire_on_resolve,"(gogoproto.nullable)",#"(gogoproto.jsontag)="expire_on_resolve""#)
	...
	expireAt?: int64 @protobuf(11,int64,name=expire_at,#"(gogoproto.jsontag)="expire_at""#)
}
