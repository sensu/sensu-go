...
#Rule: {
	...
	// to.
	resource_names?: [...string] @protobuf(3,string,#"(gogoproto.jsontag)="resource_names""#)
}
...
#ClusterRoleBinding: {
	...
	role_ref?: #RoleRef @protobuf(2,RoleRef,#"(gogoproto.jsontag)="role_ref""#,"(gogoproto.nullable)=false")
