...
func TestDeregister(t *testing.T) {
	...
	mockStore.On("GetEventsByEntity", mock.AnythingOfType("*context.valueCtx"), entity.ID).Return([]*types.Event{event}, nil)
	mockStore.On("DeleteEventByEntityCheck", mock.AnythingOfType("*context.valueCtx"), entity.ID, check.Config.Name).Return(nil)
	mockStore.On("DeleteEntity", mock.AnythingOfType("*context.valueCtx"), entity).Return(nil)
...
func TestDeregistrationHandler(t *testing.T) {
	...
	mockStore.On("GetEventsByEntity", mock.AnythingOfType("*context.valueCtx"), entity.ID).Return([]*types.Event{}, nil)
	mockStore.On("DeleteEventByEntityCheck", mock.AnythingOfType("*context.valueCtx"), entity.ID, check.Config.Name).Return(nil)
	mockStore.On("DeleteEntity", mock.AnythingOfType("*context.valueCtx"), entity).Return(nil)
