...
func (s *StoreProxy) GetClusterHealth(ctx context.Context, cluster clientv3.Cluster, etcdClientTLSConfig *tls.Config) *corev2.HealthResponse {
...
// returned if none were found.
func (s *StoreProxy) GetSilencedEntries(ctx context.Context) ([]*corev2.Silenced, error) {
...
// returned if none were found.
func (s *StoreProxy) GetSilencedEntriesByCheckName(ctx context.Context, check string) ([]*corev2.Silenced, error) {
...
// within the ctx's namespace. A nil slice with no error is
// returned if none were found.
func (s *StoreProxy) GetSilencedEntriesBySubscription(ctx context.Context, subscriptions ...string) ([]*corev2.Silenced, error) {
...
// none was found.
func (s *StoreProxy) GetSilencedEntryByName(ctx context.Context, id string) (*corev2.Silenced, error) {
	return s.do().GetSilencedEntryByName(ctx, id)
}

// UpdateHandler creates or updates a given entry.
func (s *StoreProxy) UpdateSilencedEntry(ctx context.Context, entry *corev2.Silenced) error {
	return s.do().UpdateSilencedEntry(ctx, entry)
}

// GetSilencedEntriesByName gets all the named silenced entries.
func (s *StoreProxy) GetSilencedEntriesByName(ctx context.Context, id ...string) ([]*corev2.Silenced, error) {
