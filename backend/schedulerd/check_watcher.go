...
func NewCheckWatcher(ctx context.Context, msgBus messaging.MessageBus, store store.Store, pool *ringv2.Pool, cache *cachev3.Resource, secretsProviderManager *secrets.ProviderManager) *CheckWatcher {
