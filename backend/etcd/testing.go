...
// NewTestEtcdClient creates a new Etcd and Client for testing purposes.
func NewTestEtcdClient(t *testing.T) (*Etcd, client.Client, func()) {
	tmpDir, remove := testutil.TempDir(t)
	...
	cli := client.Config{
		Endpoints:               cfg.AdvertiseClientURLs,
