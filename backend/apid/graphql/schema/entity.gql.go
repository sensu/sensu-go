...
// EntityEnvironmentFieldResolver implement to resolve requests for the Entity's environment field.
type EntityEnvironmentFieldResolver interface {
	// Environment implements response to request for environment field.
	Environment(p graphql.ResolveParams) (string, error)
}

// EntityOrganizationFieldResolver implement to resolve requests for the Entity's organization field.
type EntityOrganizationFieldResolver interface {
...
type EntityExtendedAttributesFieldResolver interface {
	...
	ExtendedAttributes(p graphql.ResolveParams) (string, error)
}
...
type EntityFieldResolvers interface {
	...
	EntityEnvironmentFieldResolver
	EntityOrganizationFieldResolver
...
// Environment implements response to request for 'environment' field.
func (_ EntityAliases) Environment(p graphql.ResolveParams) (string, error) {
	return graphql.DefaultResolver(p.Source, p.Info.FieldName)
}

// Organization implements response to request for 'organization' field.
func (_ EntityAliases) Organization(p graphql.ResolveParams) (string, error) {
	return graphql.DefaultResolver(p.Source, p.Info.FieldName)
}
...
// ExtendedAttributes implements response to request for 'extendedAttributes' field.
func (_ EntityAliases) ExtendedAttributes(p graphql.ResolveParams) (string, error) {
	return graphql.DefaultResolver(p.Source, p.Info.FieldName)
}
...
func _ObjTypeEntityDeregistrationHandler(impl interface{}) graphql1.FieldResolveFn {
	...
	return resolver.Deregistration
}
...
func _ObjTypeEntityEnvironmentHandler(impl interface{}) graphql1.FieldResolveFn {
	resolver := impl.(EntityEnvironmentFieldResolver)
	return resolver.Environment
}

func _ObjTypeEntityOrganizationHandler(impl interface{}) graphql1.FieldResolveFn {
	resolver := impl.(EntityOrganizationFieldResolver)
...
func _ObjTypeEntityExtendedAttributesHandler(impl interface{}) graphql1.FieldResolveFn {
	...
	return resolver.ExtendedAttributes
}
...
var _ObjTypeEntityDesc = graphql.ObjectDesc{
	...
	FieldHandlers: map[string]graphql.FieldHandler{
		...
		"Environment":        _ObjTypeEntityEnvironmentHandler,
		...
		"Organization":       _ObjTypeEntityOrganizationHandler,
...
func _ObjTypeSystemPlatformFamilyHandler(impl interface{}) graphql1.FieldResolveFn {
	...
	return resolver.PlatformFamily
}
...
func _ObjTypeSystemPlatformVersionHandler(impl interface{}) graphql1.FieldResolveFn {
	...
	return resolver.PlatformVersion
}
