...
func NewService(cfg ServiceConfig) (*Service, error) {
	...
	schema.RegisterCoreV3EntityConfig(svc, &corev3EntityConfigImpl{client: cfg.GenericClient})
	schema.RegisterCoreV3EntityConfigExtensionOverrides(svc, &corev3EntityConfigImpl{client: cfg.GenericClient})
	schema.RegisterCoreV3EntityState(svc, &corev3EntityStateImpl{client: cfg.GenericClient})
	schema.RegisterCoreV3EntityStateExtensionOverrides(svc, &corev3EntityStateImpl{client: cfg.GenericClient})
