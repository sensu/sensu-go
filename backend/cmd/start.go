...
func StartCommand(initialize initializeFunc) *cobra.Command {
	...
	cmd.Flags().String(backend.FlagJWTPublicKeyFile, viper.GetString(backend.FlagJWTPublicKeyFile), "path to the PEM-encoded public key to use to verify signatures")
