...
func StartCommand(initialize initializeFunc) *cobra.Command {
	...
	cmd.Flags().String(backend.FlagJWTPublicKeysFile, viper.GetString(backend.FlagJWTPublicKeysFile), "path to a list of PEM-encoded public keys to use to verify signatures")
