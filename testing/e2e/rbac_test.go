...
func TestRBAC(t *testing.T) {
	...
	output, err = adminctl.run("handler", "create", defaultHandler.Name,
		...
		"--socket-port", strconv.FormatUint(uint64(defaultHandler.Socket.Port), 10),
	...
	output, err = adminctl.run("handler", "create", devHandler.Name,
		...
		"--socket-port", strconv.FormatUint(uint64(devHandler.Socket.Port), 10),
	...
	_, err = adminctl.run("handler", "create", prodHandler.Name,
		...
		"--socket-port", strconv.FormatUint(uint64(prodHandler.Socket.Port), 10),
