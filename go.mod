...
replace go.etcd.io/etcd/api/v3 => github.com/sensu/etcd/api/v3 v3.1.0

replace go.etcd.io/etcd/client/pkg/v3 => github.com/sensu/etcd/client/pkg/v3 v3.1.0

replace go.etcd.io/etcd/client/v3 => github.com/sensu/etcd/client/v3 v3.1.0

replace go.etcd.io/etcd/pkg/v3 => github.com/sensu/etcd/pkg/v3 v3.1.0

replace go.etcd.io/etcd/server/v3 => github.com/sensu/etcd/server/v3 v3.1.0

require (
	github.com/AlecAivazis/survey/v2 v2.2.14
	github.com/atlassian/gostatsd v0.0.0-20260727064636-3f8f762e40df
	...
	github.com/sensu/core/v3 v3.10.5
