...
replace (
	github.com/atlassian/gostatsd => github.com/amdprophet/gostatsd v0.0.0-20210317022921-8c5462a5056b
	github.com/fsnotify/fsnotify => github.com/sensu/fsnotify v0.0.0-20191126053121-0adce4777482
